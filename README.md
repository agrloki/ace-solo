...
Автономное Python-приложение для управления Anycubic ACE Pro без использования Klipper. Позволяет управлять подачей филамента, парковкой, сушкой и мониторингом состояния устройства через удобный командный интерфейс.
